...
export const metadata = {
  title: 'How to install your Peace Skill',
};
  ...
  return (
    <div className="max-w-prose mx-auto px-5 sm:px-8 py-16 md:py-20">
      ...
      <h1 className="mt-3 font-serif text-4xl md:text-5xl text-neutral-ink leading-[1.1]">
        How to use your Peace Skill.
      </h1>
      <p className="mt-4 text-lg text-neutral-ink/75">
        Welcome to your Peace Skill. Here's how to get it working — takes about 90 seconds.
      </p>
      ...
      <ol className="mt-3 list-decimal pl-6 space-y-1 text-neutral-ink/85 leading-relaxed">
        ...
        <li>
          For Pro: add <code>wellbeing-reference.md</code> too
        </li>
        <li>Save.</li>
      </ol>
      ...
      <blockquote className="my-4 border-l-4 border-sage pl-4 italic text-neutral-ink/85">
        “Plan my week. Here's what's on: [list your commitments]”
      </blockquote>
      ...
      <ul className="mt-2 list-disc pl-6 space-y-1 text-neutral-ink/85 leading-relaxed">
        <li>Claude plans around your non-negotiables, not over them</li>
        <li>Your self-care routines appear in the plan as fixtures, not leftovers</li>
        <li>It leaves white space instead of filling every gap</li>
        <li>It asks about balance when the week looks overloaded</li>
      </ul>
      <p className="mt-3 text-neutral-ink/85 leading-relaxed">
