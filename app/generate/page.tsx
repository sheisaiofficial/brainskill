...
export const metadata = {
  title: 'Generate your skill — free · Brain Skill',
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-16 md:py-20">
      ...
      <h1 className="mt-3 font-serif text-4xl md:text-5xl text-neutral-ink leading-[1.1]">
        Generate your Brain Skill.
      </h1>
      <p className="mt-4 text-lg text-neutral-ink/75">
        Drop in your profile. We'll read it, build the skill, and email it through. Takes about
        a minute.
      </p>
      ...
      <div className="text-sm text-neutral-ink/70 max-w-prose">
        <p>
          <strong>Privacy:</strong> profile content is sent to Anthropic to generate the skill,
