...
export default function GenerateForm({ tier, stripeSessionId, initialEmail = '' }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (method === 'paste' && text.trim().length < 100) {
      setError(
        "We need a bit more to work with. Tell us about how you work best, or upload your assessment result."
      );
      return;
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-7">
      ...
      {/* Profile type */}
      <Field label="Where's your profile from?" hint="Optional — helps Claude calibrate">
        <select
          value={profileType}
      ...
      <div>
        <div className="text-sm font-medium text-neutral-ink mb-3">
          Bring your profile <span className="text-rose-700">*</span>
        </div>
          ...
          {method === 'paste' && (
            <>
              <textarea
                ...
                rows={10}
                placeholder="Paste your card-sort result, your StrengthsFinder report, or write a few paragraphs about how you actually work…"
      ...
      <div className="pt-2">
        ...
        <p className="mt-3 text-xs text-neutral-ink/55">
          Your profile is deleted from our server the moment your skill is generated.
        </p>
      </div>
    </form>
  );
    ...
    <div className="space-y-7">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
        <a
          ...
          download={tier === 'pro' ? 'brain-skill-pro.zip' : 'SKILL.md'}
      ...
      {tier === 'free' && (
        <div className="rounded-2xl bg-neutral-ink text-neutral-paper p-7">
          ...
          <p className="text-lg leading-relaxed">
            Want the Pro version? Add: energy mapping, overwhelm protocols, decision support,
            and COO agent integration. → Upgrade for $47.
          </p>
          <div className="mt-5">
